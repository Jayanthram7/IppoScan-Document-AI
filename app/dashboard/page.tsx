...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F7F4] text-gray-900">
      ...
      <header className="flex items-center justify-between px-6 py-3 gap-4 bg-[#F8F7F4]">
        {/* Left: Logo + Title */}
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center p-1 shadow-sm border border-gray-200">
          ...
          <div className="flex flex-col leading-tight">
            <span className="text-lg font-bold text-gray-900 tracking-tight">Dashboard</span>
            <span className="text-xs text-gray-600 font-medium">Overview & Analytics</span>
          </div>
        </div>

        {/* Center Pill Navigation */}
        <nav className="flex items-center gap-1 bg-white p-1.5 rounded-full shadow-sm border border-gray-200">
          {['Overview', 'Customers', 'Suppliers', 'Orders'].map((tab) => (
            <button
              key={tab}
              onClick={() => handleTabClick(tab)}
              className={`px-5 py-1.5 rounded-full text-sm font-medium transition-all duration-200 ${activeTab === tab
                ? 'text-emerald-600 border-b-2 border-emerald-500 shadow-[0_3px_10px_rgba(16,185,129,0.35)] rounded-full'
          ...
          {/* Divider + Download icon — placeholder for future feature */}
          <div className="w-px h-5 bg-gray-200 mx-2"></div>
          <button
            className="pl-1 pr-2 py-1.5 text-gray-600 hover:text-gray-900 transition-colors rounded-full hover:bg-gray-50"
            title="Export Report"
          >
      ...
      {/* Main Content Area */}
      <main className="pt-1 px-6 pb-6 max-w-[1400px] mx-auto space-y-4">
        ...
        {activeTab === 'Overview' && (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              {/* LEFT column: Total Profit chart + Latest Shipment */}
              <div className="lg:col-span-2 flex flex-col gap-4">
                ...
                {/* Latest Shipment — same width as chart above */}
                <div className="bg-white p-4 rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all duration-200">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-sm font-bold text-gray-900">Latest Shipment</h3>
                    <span className="text-[10px] font-semibold text-sky-600 bg-sky-50 px-2 py-0.5 rounded-full">Live</span>
                  </div>
                  <div className="relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <div className="flex-1 h-0.5 bg-gray-100 relative overflow-hidden rounded-full">
                        <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-emerald-400 to-sky-400 rounded-full shipment-bar">
                        </div>
                      </div>
                      <div className="flex flex-col items-center">
                        <span className="w-2.5 h-2.5 rounded-full bg-gray-200 ring-2 ring-gray-100"></span>
                      </div>
                    </div>
                    {/* Plane icon + details in a horizontal row since we have more width */}
                    <div className="flex items-center gap-4">
                      <div className="w-9 h-9 rounded-full bg-sky-100 flex items-center justify-center flex-shrink-0 plane-bob">
                        <svg className="w-5 h-5 text-sky-600" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M21 16v-2l-8-5V3.5c0-.83-.67-1.5-1.5-1.5S10 2.67 10 3.5V9l-8 5v2l8-2.5V19l-2 1.5V22l3.5-1 3.5 1v-1.5L13 19v-5.5l8 2.5z" />
                        </svg>
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-gray-900">SHP-2024-412</p>
                        <p className="text-xs text-gray-500">Mumbai → Chennai · In Transit</p>
                      </div>
                      <span className="text-xs font-medium text-amber-600 bg-amber-50 px-2 py-1 rounded-md whitespace-nowrap">~2h ETA</span>
                      <div className="flex gap-3">
                        <div className="bg-gray-50 rounded-lg px-3 py-2 text-center">
                          <p className="text-[10px] text-gray-400 font-medium">Items</p>
                          <p className="text-sm font-bold text-gray-900">24 units</p>
                        </div>
                        <div className="bg-gray-50 rounded-lg px-3 py-2 text-center">
                        ...
                        <div className="bg-sky-50 rounded-lg px-3 py-2 text-center">
                          <p className="text-[10px] text-sky-500 font-medium">Status</p>
                          <p className="text-sm font-bold text-sky-700">On Track</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  @keyframes shipmentProgress {
                    0% { width: 10%; }
                    50% { width: 70%; }
                    100% { width: 10%; }
                  }
                  .plane-bob { animation: planeBob 2s ease-in-out infinite; }
                  .shipment-bar { animation: shipmentProgress 3s ease-in-out infinite; }
                `}</style>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                {/* Recent Activity */}
                <div className="bg-white p-3 rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all duration-200 flex-1">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      { type: 'check', title: 'Payment Verified', detail: 'INV-2024-002 cleared', time: '4h ago', color: 'green' },
                    ].map((activity, i) => (
                      <div key={i} className="flex items-start gap-3 p-2 rounded-lg hover:bg-gray-50 transition-colors">
                        <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 ${activity.color === 'blue' ? 'bg-blue-100' : activity.color === 'red' ? 'bg-red-100' : 'bg-green-100'
                          }`}>
...
function MetricCard({
  ...
  return (
    <div className={`bg-white p-3.5 rounded-xl border border-gray-200 hover:border-gray-300 hover:shadow-md transition-all duration-200 ${className}`}>
      <div className="flex items-center justify-between mb-2">
