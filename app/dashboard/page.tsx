        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2.5 pl-3 border-l border-gray-200">
            ...
            <div className="leading-tight hidden md:block">
              <p className="text-sm font-semibold text-gray-900">Nithin Krishna</p>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              <div>
                <h2 className="text-3xl font-bold text-gray-900 flex items-center gap-2">
                  Welcome, Nithin Krishna <span className="text-3xl">👋</span>
                </h2>
                      ...
                      return (
                        <div key={i} className="flex-1 flex flex-col items-center justify-end gap-1">
                          <div className="w-full flex items-end justify-center gap-0.5 group relative" style={{ height: '208px' }}>
                            ...
                            <div
                              className="w-[45%] rounded-t transition-all duration-300 bg-orange-400 group-hover:bg-orange-500 self-end"
                              style={{ height: `${purchasesHeightPx}px` }}
                            />
                            {/* Sales Bar (Blue) */}
                            <div
                              className="w-[45%] rounded-t transition-all duration-300 bg-blue-400 group-hover:bg-blue-500 self-end"
