...
export function AnomalyList({ title, description }: AnomalyListProps) {
    ...
    const fetchInvoices = async () => {
        try {
            ...
            if (response.ok) {
                ...
                // Filter for invoices that are NOT 'Valid'
                const filtered = (data.invoices || []).filter(
                    (inv: Invoice) => inv.validation_status !== 'Valid'
                );
        ...
        <div className="p-8 bg-[#F8F7F4] min-h-screen">
            ...
            <div className="bg-white rounded-xl border border-gray-200">
                <div className="p-5 border-b border-gray-200 flex items-center justify-between">
                    <h3 className="text-lg font-bold text-gray-900">Anomalous Invoices ({filteredInvoices.length})</h3>
